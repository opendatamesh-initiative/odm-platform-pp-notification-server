...
class EventSubscriberPersistenceOutboundPortImpl implements EventSubscriberPersistenceOutboundPort {

    private final SubscriptionService subscriptionService;

    EventSubscriberPersistenceOutboundPortImpl(SubscriptionService subscriptionService) {
